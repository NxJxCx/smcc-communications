...
export default function ThumbnailItemWithDepartment({ isPreparedBy, layout, series, thumbnailSrc, department, label, createdAt, updatedAt, isRejected, preparedByMe, isPending, onClick, isRead }: { isPreparedBy: string, layout: ViewLayout, series?: string, thumbnailSrc: string; department: string; label: string|React.ReactNode; createdAt?: Date|string|null, updatedAt?: Date|string|null, isRejected?: boolean, preparedByMe?: boolean, isPending?: boolean, onClick: (e?: any) => void, isRead?: boolean }) {
  return (<>
    {layout === "grid" && (
