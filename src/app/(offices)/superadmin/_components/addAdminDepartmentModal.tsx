...
import { ActionResponseType, addAdminDepartment } from "@/actions/superadmin";
...
export default function AddAdminDepartmentModal({
  ...
  const [state, action, pending] = useFormState<ActionResponseType, FormData>(addAdminDepartment.bind(null, id as string), {})
